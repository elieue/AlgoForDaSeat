...
async function seed() {
  ...
  age, last_school_attended
      ...
      ('A1B2C3D4', 'Miguel Lorenzo Dela Cruz', 'migslorenzo@gmail.com', 135687411216, 92.4, 88, 'Pasig City', 9.0, 180000, 'Medium', 'ITR', 'Male', 'Tagalog', 18, 'Pasig City Science High School'),
      ...
      ('M5N6O7P8', 'Samantha Anne Lopez', 'samlopez98@gmail.com', 199875412356, 90.1, 85, 'Mandaluyong City', 7.5, 150000, 'Medium', 'ITR', 'Female', 'Tagalog', 18, 'Mandaluyong High School'),
      ...
      ('Q9R8S7T6', 'Andrea Faith Mendoza', 'afmendoza12@gmail.com', 144785214326, 88.9, 82, 'Manila', 5.0, 134000, 'Medium', 'ITR', 'Female', 'Tagalog', 18, 'Manila Science High School'),
      ...
      ('Z5A6B7C8', 'Rafael Dominic Reyes', 'rafareyes123@gmail.com', 167895231125, 91.8, 89, 'Taguig City', 6.3, 202000, 'Medium', 'ITR', 'Male', 'Tagalog', 18, 'Taguig Science High School'),
      ('L3M4N5O6', 'Beatrice Julianne Cruz', 'beajcruz@gmail.com', 176542788911, 89.5, 86, 'Parañaque City', 10.0, 123000, 'Medium', 'ITR', 'Female', 'Tagalog', 19, 'Parañaque National High School'),
      ...
      ('J7K8L9M0', 'Luis Martin Ramos', 'luismramos08@gmail.com', 167887411200, 90.6, 88, 'Marikina City', 8.2, 160000, 'Medium', 'ITR', 'Male', 'Tagalog', 17, 'Marikina Science High School'),
      ...
      ('T1U2V3W4', 'Isabella Marie Salazar', 'isabellasalazar@gmail.com', 178654321900, 92.9, 90, 'Makati City', 4.5, 210000, 'Medium', 'ITR', 'Female', 'Tagalog', 18, 'Fort Bonifacio High School'),
      ('N6O7P8Q9', 'Joshua Emmanuel Navarro', 'joshnavs@gmail.com', 156732198877, 85.6, 83, 'Muntinlupa City', 13.5, 120000, 'Medium', 'ITR', 'Male', 'Tagalog', 19, 'Muntinlupa National High School'),
      ...
      ('W7X8Y9Z0', 'Monica Therese Fabros', 'monicafabros@gmail.com', 147865432134, 91.4, 87, 'Manila', 3.1, 195000, 'Medium', 'ITR', 'Female', 'Tagalog', 18, 'Arellano University - Juan Sumulong Campus'),
      ('C1D2E3F4', 'Jose Miguel Abad', 'jmabad2006@gmail.com', 167754332147, 87.9, 80, 'Makati City', 6.5, 145000, 'Medium', 'ITR', 'Male', 'Tagalog', 19, 'Pitogo High School'),
      ...
      ('V8W9X0Y1', 'Daniel Reyes Bartolome', 'danrbartolome@yahoo.com', 198654321167, 90.0, 85, 'Quezon City', 7.4, 170000, 'Medium', 'ITR', 'Male', 'Ilocano', 18, 'Commonwealth High School'),
      ...
      ('D7E8F9G0', 'Nathaniel Cruz Santiago', 'nathsantiago01@gmail.com', 123456789001, 88.2, 81, 'Pasig City', 10.1, 110000, 'Medium', 'ITR', 'Male', 'Tagalog', 19, 'Rizal High School');
    `);
